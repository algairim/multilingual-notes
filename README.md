...
The script will obtain a JWT access token, create a new note, list all notes, request a summary and translation, and then delete the note, printing its progress at each step.
